...
aliases or an upstream marketplace into core. Official azure-blob/files/github/local/sql-server aliases resolve in the shared CLI/MCP adapter using qualified
